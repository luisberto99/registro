...
<body>
            ...
            <div class="row">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <label class="control-label" for="slc-carrera">Seleccione el departamento:</label>
                        <div class="form-group" id="div-slc-carrera">
                          <?php echo Matricula::generarCarreras($link); ?>
                        </div>
                        <label class="control-label" for="slc-asignatura">Seleccione la asignatura:</label><!--br-->
                        <div class="form-group" id="div-slc-asignatura">
                          <!-- Asignaturas -->
                        </div>
                        <label class="control-label" for="slc-seccion">Seleccione una secci&oacute;n:</label>
                        <div class="form-group" id="div-slc-seccion">
                          <!-- Secciones -->
                        </div>
                    </div>
                    <div class="panel-footer">
                        <button type="button" class="btn btn-default" id="btn-matricula-cancelar">Cancelar</button>
                        <button type="button" class="btn btn-primary" id="btn-matricula-guardar">Guardar</button>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="panel panel-info">
                    <div class="panel-heading">
                       <b>Clases matriculadas</b>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <table class="table table-striped table-hover" id="tbl-matriculas">
                                <th></th>
                                <th>Tipo</th>
                                <th>Asignatura</th>
                                <th>Aula</th>
    ...
    <script src="../js/controlador_matricula.js"></script>
</body>
</html>
